...
const WaveIcons = [
  ['274:12839', 'wave/icon-1'],
  ['274:12848', 'wave/icon-2'],
  ['274:12853', 'wave/icon-3'],
  ['274:12829', 'wave/icon-4'],
  ['274:12784', 'wave/icon-5'],
  ['274:12843', 'wave/icon-6'],
  ['274:12819', 'wave/icon-7'],
  ['274:12835', 'wave/icon-8'],
  ['274:12796', 'wave/icon-9'],
  ['274:12811', 'wave/icon-10'],
  ['274:12788', 'wave/icon-11'],
  ['274:12803', 'wave/icon-12'],
  ['274:12871', 'wave/icon-13'],
  ['274:12866', 'wave/icon-14'],
  ['274:12863', 'wave/icon-15'],
  ['274:12857', 'wave/icon-16'],
];
...
function collect(node, origin, out) {
  ...
  if (fill) {
    for (const { path: d, windingRule } of node.fillGeometry ?? []) {
      ...
      out.push(
        `<g${shift}><path d="${d}" fill="${fill.hex}"${rule}${alpha}/></g>`,
      );
    }
  }
  ...
  if (stroke) {
    for (const { path: d, windingRule } of node.strokeGeometry ?? []) {
      ...
      out.push(
        `<g${shift}><path d="${d}" fill="${stroke.hex}"${rule}${alpha}/></g>`,
      );
    }
  }
