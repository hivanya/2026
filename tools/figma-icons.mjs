...
//
// ОСТОРОЖНО: сдвиг — единственное, что мы применяем. Если у узла в
// relativeTransform лежит отражение или поворот, контур приедет
// неотражённым, и иконка выйдет зеркальной (так вышло с shuffle).
// Пока рендер-эндпоинт в 429, такие иконки правятся руками:
//   sips -f horizontal public/images/wave/icon-N.png --out ...
// Когда бюджет рендера освободится, иконки лучше перевыгрузить
// через /v1/images — там отражения учтены
